...
\label{sec:org93e23fa}
\begin{itemize}
\item Ph.D., Psychology, East Texas A\&M University, 2010
...
\label{sec:org5c8e006}
\subsubsection*{Administrative Positions}
\label{sec:org4fa85ec}
\begin{itemize}
\item 2025-present: Dean, College of Graduate Studies, Tarleton State University
\item 2024-2025: Associate Dean, College of Graduate Studies, Tarleton State University
...
\end{itemize}
\subsection*{Past administrative duties and accomplishments}
\label{sec:orge5ff758}

\subsubsection*{2024-2025: Associate Dean, College of Graduate Studies}
\label{sec:org79916be}
\begin{itemize}
\item \emph{Duties and responsibilities:}
\begin{itemize}
\item Assist the Dean in administering the operations and initiatives of the College of Graduate Studies
\item Oversee specific graduate education areas as assigned, such as student support services, compliance, or program assessment.
\item Collaborate with Academic Deans, Assistant and Associate Deans, Department Chairs, Graduate Program Directors and Graduate Advisors, faculty, and staff to ensure the quality and growth of graduate programs.
\item Represent the College of Graduate Studies in University-wide committees and initiatives as designated by the Dean.
\item Serve as acting Dean in the absence of the Dean.
\end{itemize}

\item \emph{Key accomplishments during my leadership:}
\begin{itemize}
\item I created a new Statistical Consulting service in the College of Graduate Studies. This involved performing a needs assessment for the types of statistical consulting, hiring and managing a graduate assistant as the consultant, and creating the technical infrastructure for the service, including a webpage, intake form, and evaluation process.
\item I streamlined the graduate program review process, including the creation of a new assessment manual, recruitment of external reviewers, and management and coordination of the process throughout the academic year.
\item I hosted research support workshops for graduate students, including topics such as statistical methods, writing support, and qualitative methods.
\item I led a committee of graduate students to lay the groundwork for a new Graduate and Professional Student Council (GPSC).
\item I assisted the Dean with the organization and execution of the TAMUS Pathways Conference, held on the Tarleton campus in February 2025.
\end{itemize}
\end{itemize}
\subsubsection*{2021-2024: Head of Psychological Sciences}
\label{sec:org16557da}
\begin{itemize}
\item \emph{Duties and responsibilities:}
\begin{itemize}
...
\label{sec:org01c7a15}
\subsubsection*{External Leadership}
\label{sec:org21ac5ab}

\begin{itemize}
\item Chair, Psychonomic Society Finance Commitee (appointed 2024-present)
\item Treasurer, Society for Mathematical Psychology (appointed 2025-present)
...
\end{itemize}
\subsection*{Books}
\label{sec:org1e0ea77}
\begin{enumerate}
\item Faulkenberry, T. J. (2025). \emph{Bayesian Statistics: The Basics}. New York: Routledge. \url{https://doi.org/10.4324/9781003470199}
...
\end{enumerate}
\subsection*{Papers}
\label{sec:org50afd82}
\begin{enumerate}
\item Faulkenberry, T. J. (in press). Closed-form approximations of the two-sample Pearson Bayes factor. To appear in \emph{Lithuanian Journal of Statisitcs}, \url{https://arxiv.org/abs/2310.11313}
\item Maloney, E. A., Faulkenberry, T. J., \& LeFevre, J.-A. (2025). Branching out while remembering our roots: A special issue on numerical and mathematical cognition. \emph{Canadian Journal of Experimental Psychology, 79} (2), 125–128. \url{https://doi.org/10.1037/cep0000376}
\item Zapata, I. \& Faulkenberry, T. J. (2024). Closed-form estimates of ex-Gaussian response time models in two-digit number comparison. \emph{Journal of Psychological Inquiry, 28} (2), 5-14. \url{https://www.psychinquiry.org/wp-content/uploads/2025/02/v28n2.pdf}
...
\item Faulkenberry, T. J., Cruise, A., \& Shaki, S. (2020). Task instructions modulate unit-decade binding in two-digit number representation. \emph{Psychological Research}, \emph{84}, 424-439. \url{https://doi.org/[[https://dx.doi.org/10.1007/s00426-018-1057-9][10.1007/s00426-018-1057-9]]}
\item Faulkenberry, T. J. (2019). Estimating evidential value from ANOVA summaries: A comment on Ly et al. (2018). \emph{Advances in Methods and Practices in Psychological Science}, \emph{2}, 406-409. \url{https://doi.org/[[https://doi.org/10.1177/2515245919872960][10.1177/2515245919872960]]}
\item Faulkenberry, T. J. (2019). A tutorial on generalizing the default Bayesian t-test via posterior sampling and encompassing priors. \emph{Communications for Statistical Applications and Methods}, \emph{26}, 217-238. \url{https://doi.org/[[https://doi.org/10.29220/CSAM.2019.26.2.217][10.29220/CSAM.2019.26.2.217]]}
...
\item Faulkenberry, T. J., Vick, A. D., \& Bowman, K. A. (2018). A shifted Wald decomposition of the numerical size-congruity effect: Support for a late interaction account. \emph{Polish Psychological Bulletin}, \emph{49}, 391-397. \url{https://doi.org/[[http://dx.doi.org/10.24425/119507][10.24425/119507]]}
\item Faulkenberry, T. J., Witte, M., \& Hartmann, M. (2018). Tracking the continuous dynamics of numerical processing: A brief review and editorial. \emph{Journal of Numerical Cognition}, \emph{4} (2), 271-285. \url{https://doi.org/[[http://dx.doi.org/10.5964/jnc.v4i2.179][10.5964/jnc.v4i2.179]]}
\item Faulkenberry, T. J. (2018). Computing Bayes factors to measure evidence from experiments: An extension of the BIC approximation. \emph{Biometrical Letters}, \emph{55} (1), 31-43. \url{https://doi.org/[[https://doi.org/10.2478/bile-2018-0003][10.2478/bile-2018-0003]]}
...
\item Faulkenberry, T. J. (2017). A single-boundary accumulator model of response times in an arithmetic verification task. \emph{Frontiers in Psychology}, \emph{8:1225}. \url{https://doi.org/[[http://dx.doi.org/10.3389/fpsyg.2017.01225][10.3389/fpsyg.2017.01225/]]}
\item Faulkenberry, T. J., Cruise, A., \& Shaki, S. (2017). Reversing the manual digit bias in two-digit number comparison. \emph{Experimental Psychology}, \emph{64}, 191-204. \url{https://doi.org/[[http://dx.doi.org/10.1027/1618-3169/a000365][10.1027/1618-3169/a000365]]}
\item Sobel, K. V., Puri, A. M., Faulkenberry, T. J., \& Dague, T. D. (2017). Visual search for conjunctions of physical and numerical size shows that they are processed independently. \emph{Journal of Experimental Psychology: Human Perception \& Performance}, \emph{43}, 444-453. \url{https://doi.org/[[http://dx.doi.org/10.1037/xhp0000323][10.1037/xhp0000323]]}
\item Faulkenberry, T. J., \& Tummolini, L. (2016). Commentary: Is there any Influence of Variations in Context on Object-Affordance Effects in Schizophrenia? Perception of Property and Goals of Action). \emph{Frontiers in Psychology}, \emph{7:1915}. \url{https://doi.org/[[http://dx.doi.org/10.3389/fpsyg.2016.01915][10.3389/fpsyg.2016.01915]]}
\item Faulkenberry, T. J. (2016). Testing a direct mapping versus competition account of response dynamics in number comparison. \emph{Journal of Cognitive Psychology}, \emph{28}, 825-842. \url{https://doi.org/[[http://dx.doi.org/10.1080/20445911.2016.1191504][10.1080/20445911.2016.1191504]]}
\item Sobel, K. V., Puri, A. M., \& Faulkenberry, T. J. (2016). Bottom-up and top-down attentional contributions to the size-congruity effect. \emph{Attention, Perception, \& Psychophysics}, \emph{78}, 1324-1336. \url{https://doi.org/[[http://dx.doi.org/10.3758/s13414-016-1098-3][10.3758/s13414-016-1098-3]]}
\item Faulkenberry, T. J., Cruise, A., Lavro, D., \& Shaki, S. (2016). Response trajectories capture the continuous dynamics of the size congruity effect. \emph{Acta Psychologica}, \emph{163}, 114-123. \url{https://doi.org/[[http://dx.doi.org/10.1016/j.actpsy.2015.11.010][10.1016/j.actpsy.2015.11.010]]}
\item Faulkenberry, T. J., Montgomery, S. A., \& Tennes, S. N. (2015). Response trajectories reveal the temporal dynamics of fraction representations. \emph{Acta Psychologica}, \emph{159}, 100-107. \url{https://doi.org/[[http://dx.doi.org/10.1016/j.actpsy.2015.05.013][10.1016/j.actpsy.2015.05.013]]}
\item Faulkenberry, T. J., \& Rey, A. R. (2014). Extending the reach of mousetracking in numerical cognition: A comment on Fischer and Hartmann (2014). \emph{Frontiers in Psychology}, \emph{5}:1436. \url{https://doi.org/[[http://dx.doi.org/10.3389/fpsyg.2014.01436][10.3389/fpsyg.2014.01436]]}
\item Faulkenberry, T. J. (2014). Hand movements reflect competitive processing in numerical cognition. \emph{Canadian Journal of Experimental Psychology}, \emph{68}, 147-151. \url{https://doi.org/[[http://dx.doi.org/10.1037/cep0000021][10.1037/cep0000021]]}
...
\item Faulkenberry, T. J., (2013). The conceptual/procedural distinction belongs to strategies, not tasks: A comment on Gabriel et al. (2013). \emph{Frontiers in Psychology}, \emph{4}:820. \url{https://doi.org/[[http://dx.doi.org/10.3389/fpsyg.2013.00820][10.3389/fpsyg.2013.00820]]}
...
\item Faulkenberry, T. J., \& Pierce, B. H. (2011). Mental representations in fraction comparison: Holistic versus component-based strategies. \emph{Experimental Psychology}, \emph{58}, 480-489. \url{https://doi.org/[[http://dx.doi.org/10.1027/1618-3169/a000116][10.1027/1618-3169/a000116]]}
...
\label{sec:orgd8b4a96}
\begin{itemize}
\item Managing Editor (2026-present): \emph{Journal of Psychological Inquiry}
\item Associate Editor (2025-present): /Journal of Numerical Cognition)
\item Associate Editor (2024-present): \emph{Behavior Research Methods}
\item Guest Editor (2023-2025): \emph{Canadian Journal of Experimental Psychology}
\item Associate Editor (2016-2025): \emph{Journal of Psychological Inquiry}
\item Editorial Board (2019-2024): \emph{Journal of Numerical Cognition}
...
\label{sec:org389c3e3}

External Leadership Positions and Committee Membership

\begin{itemize}
\item Chair, Psychonomic Society Finance Commitee (appointed 2024-present)
\item Treasurer, Society for Mathematical Psychology (elected 2025-present)
\item Program Chair, Southwestern Psychological Association (appointed 2024-present)
\item President, Southwestern Psychological Association (elected 2021-2024)
...
\label{sec:org2491008}
\subsubsection*{Doctoral Dissertation Chair}
\label{sec:org77372c4}
\begin{itemize}
\item Kate Sims (Experimental Psychology, Tarleton, in progress)
\end{itemize}
\subsubsection*{Masters Thesis Chair}
\label{sec:org667c2ff}
\begin{itemize}
\item Steven McMullin (Applied Psychology, Tarleton, in progress)
\item Landry Smith (Applied Psychology, Tarleton, graduated 2025)
...
\label{sec:org4992bf2}
\begin{itemize}
\item Kristen Bowman (Experimental Psychology, TAMU-C, in progress)
\item Addie Caudle (Educational Leadership, Tarleton, graduated 2025)
...
\label{sec:orgfe97478}
\begin{itemize}
\item Shanna Coury (Psychology, TAMU-C, graduated 2025)
\item Sam Arthur (Psychology, Tarleton, graduated 2023)
