...
\item Faulkenberry, T. J. (2020). The Pearson Bayes factor: An analytic formula for computing evidential value from minimal summary statistics. \emph{arXiv}, \url{https://arxiv.org/abs/2011.09549}
...
\label{sec:org8469eae}
\subsubsection*{Masters Thesis Chair}
\label{sec:org70e3a41}
\begin{itemize}
