...
\label{sec:orgd38bebb}
\begin{enumerate}
\item Faulkenberry, T. J. (in press). A tutorial on generalizing the default Bayesian t-test via posterior sampling and encompassing priors. To appear in \emph{Communications for Statistical Methods and Applications}
