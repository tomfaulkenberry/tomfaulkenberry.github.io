...
\subsection*{Papers}
\label{sec:org1c2441e}
\begin{enumerate}
\item Faulkenberrry, T. J., \& Bowman, K. A. (in press). Bayesian modeling of the latent structure of individual differences in the numerical size-congruity effect. To appear in \emph{Journal of Cognitive Psychology}, \url{https://psyarxiv.com/4b9rs/}
...
\label{sec:orga6e669b}
\begin{enumerate}
\item Faulkenberry, T. J., \& Brennan, K. B. (2022). Computing analytic Bayes factors from summary statistics in repeated-measures designs. \emph{arXiv}, \url{https://arxiv.org/abs/2209.08159}
\item Faulkenberry, T. J. (2022). A note on the normality assumption for modeling constraint in cognitive individual differences. \emph{arXiv}, \url{https://arxiv.org/abs/2112.05503}
...
\item Faulkenberry, T. J. (April, 2021). Gamma function approximations for computing closed-form Bayes factors. Mathematical Association of America Texas Section Meeting. Virtual/online.
...
\label{sec:orgd29cbc1}

\emph{PI unless otherwise noted.  Total funding = \$390,374}
...
\label{sec:orgb6dafb8}

National/regional service 

\begin{itemize}
\item President, Southwestern Psychological Association (elected 2021-2024)
\item Chair, ASA-MAA Joint Committee on Statistics and Data Science Education (appointed 2022-2023)
\item Member, MAA Council on Teaching and Learning (appointed 2022-2023)
\item Secretary/Treasurer, MAA Special Interest Group (SIGMAA) on Statistics Education (elected 2020-2022)
\item Member, ASA-MAA Joint Committee on Statistics Education (appointed 2020-2023)
...
\label{sec:org7756327}
\subsubsection*{Masters Thesis Chair}
\label{sec:org8c3cb43}
\begin{itemize}
\item Keelyn Brennan (Applied Psychology, Tarleton, in progress)
...
\label{sec:org776e267}
\begin{itemize}
\item Angelika Stefan (Psychological Methods, University of Amsterdam, in progress)
