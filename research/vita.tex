...
\label{sec:orga55f178}
\begin{enumerate}
\item Faulkenberry, T. J. (2021). A note on the normality assumption for modeling constraint in cognitive individual differences. \emph{arXiv}, \url{https://arxiv.org/abs/2112.05503}
...
\label{sec:org0a174b2}

\emph{PI unless otherwise noted.  Total funding = \$330,956}
...
\item PSYC 5316: Advanced Quantitative Methods, Fall 17,18,19,20,21
...
\label{sec:orgc1f2c89}
\subsubsection*{Masters Thesis Chair}
\label{sec:org4afc80e}
\begin{itemize}
