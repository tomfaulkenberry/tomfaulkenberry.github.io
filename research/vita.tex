...
\label{sec:org75e9f20}
\subsubsection*{Administrative Positions}
\label{sec:orgf0ef698}
\begin{itemize}
...
\label{sec:org0389c15}
\subsubsection*{External Leadership}
\label{sec:org5a5bb6d}
...
\subsection*{Books}
\label{sec:orgcc247a1}
\begin{enumerate}
\item Faulkenberry, T. J. (in press). \emph{Bayesian Statistics: The Basics}. New York: Routledge. To appear in April 2025
...
\label{sec:org2fdc360}
\subsubsection*{Masters Thesis Chair}
\label{sec:orgd5a3cf8}
\begin{itemize}
