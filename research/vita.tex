...
\label{sec:org6699e21}
\begin{enumerate}
\item Faulkenberry, T. J., Ly, A., \& Wagenmakers, E. J. (in press). Bayesian statistics in numerical cognition: A tutorial using JASP. To appear in \emph{Journal of Numerical Cognition}. \url{https://psyarxiv.com/vg9pw/}
...
\label{sec:org0a45459}
\subsubsection*{Masters Thesis Chair}
\label{sec:org9580972}
\begin{itemize}
