...
1. Faulkenberry, T. J. (in press). A single-boundary accumulator model of response times in an arithmetic verification task. To appear in /Frontiers in Psychology/
